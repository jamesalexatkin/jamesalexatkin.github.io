...
[![Lint](https://github.com/jamesalexatkin/jamesalexatkin.github.io/actions/workflows/lint.yml/badge.svg)](https://github.com/jamesalexatkin/jamesalexatkin.github.io/actions/workflows/lint.yml)
...
Justfile gives useful commands:

- `just install`
- `just dev` - compile for local with auto-reload
- `just lint` and `just lint_fix`
- `bede_build` - build writing posts using Bede
